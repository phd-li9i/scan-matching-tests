...
alg_id = {'CSM/implm1', 'FMT/implm1', 'FMT/implm2', 'FMT/implm3', 'FMT/implm4', 'FMT/implm5', 'FMT/implm6'};
alg_id_txt = {'CSM', 'implm1', 'implm2', 'implm3', 'implm4', 'implm5', 'implm6'};
...
if store
  img_file = strcat(print_dir, '/errors_', alg_id_txt{7}, '_1.eps');
...
if store
  img_file = strcat(print_dir, '/errors_', alg_id_txt{7}, '_2.eps');
  drawnow ("epslatex", img_file, false);
end
...
if store
  img_file = strcat(print_dir, '/errors_', alg_id_txt{7}, '_3.eps');
  drawnow ("epslatex", img_file, false);
end
...
if store
  img_file = strcat(print_dir, '/errors_', alg_id_txt{7}, '_4.eps');
  drawnow ("epslatex", img_file, false);
end
...
if store
  img_file = strcat(print_dir, '/errors_', alg_id_txt{7}, '_5.eps');
  drawnow ("epslatex", img_file, false);
end
...
if store
  img_file = strcat(print_dir, '/errors_', alg_id_txt{7}, '_6.eps');
  drawnow ("epslatex", img_file, false);
end
...
if store
  img_file = strcat(print_dir, '/times_', alg_id_txt{7}, '_1.eps');
  drawnow ("epslatex", img_file, false);
end
...
if store
  img_file = strcat(print_dir, '/times_', alg_id_txt{7}, '_2.eps');
  drawnow ("epslatex", img_file, false);
end
...
if store
  img_file = strcat(print_dir, '/times_', alg_id_txt{7}, '_3.eps');
  drawnow ("epslatex", img_file, false);
end
...
if store
  img_file = strcat(print_dir, '/times_', alg_id_txt{7}, '_4.eps');
  drawnow ("epslatex", img_file, false);
end
...
if store
  img_file = strcat(print_dir, '/times_', alg_id_txt{7}, '_5.eps');
  drawnow ("epslatex", img_file, false);
end
...
if store
  img_file = strcat(print_dir, '/times_', alg_id_txt{7}, '_6.eps');
  drawnow ("epslatex", img_file, false);
end
